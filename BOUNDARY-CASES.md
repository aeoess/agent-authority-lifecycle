...
Cases are grouped by why each one is out of scope. Each also carries a semantic family, shown in the index below, which records the nearest authority question rather than a claim that the case resolves to an authority verdict.

## Contents

- [Execution and scheduler mechanics](#execution-and-scheduler-mechanics) (5)
- [Implementation or configuration defect](#implementation-or-configuration-defect) (2)
- [Liability or legal consequence](#liability-or-legal-consequence) (5)
- [No authority transition in the scenario](#no-authority-transition-in-the-scenario) (2)
- [No verifier in the scenario](#no-verifier-in-the-scenario) (3)
- [Security control](#security-control) (19)

<details>
<summary>All 36 boundary cases</summary>

| ID | Case | Out of scope because | Semantic family | Domain | Tier |
|---|---|---|---|---|---|
| [LC-E-010](#lc-e-010-idempotency-key-retry-returns-the-original-result-instead-of-re-executing-the-effect) | Idempotency-key retry returns the original result instead of re-executing the effect | [Execution and scheduler mechanics](#execution-and-scheduler-mechanics) | In-flight actions and authorization boundaries | platform-engineering | boundary |
| [LC-E-011](#lc-e-011-a-reused-idempotency-key-with-changed-parameters-errors-outright-rather-than-silently-doing-either-the-old-or-the-new-thing) | A reused idempotency key with changed parameters errors outright, rather than silently doing either the old or the new thing | [Execution and scheduler mechanics](#execution-and-scheduler-mechanics) | In-flight actions and authorization boundaries | platform-engineering | boundary |
| [LC-E-017](#lc-e-017-a-recurring-scheduler-needs-an-explicit-named-policy-for-late-and-overlapping-occurrences-not-a-silent-default) | A recurring scheduler needs an explicit, named policy for late and overlapping occurrences, not a silent default | [Execution and scheduler mechanics](#execution-and-scheduler-mechanics) | Scheduled and dormant authority | platform-engineering | boundary |
| [LC-E-022](#lc-e-022-a-schedulers-at-least-once-delivery-guarantee-means-the-target-not-the-scheduler-has-to-prevent-duplicate-execution) | A scheduler's at-least-once delivery guarantee means the target, not the scheduler, has to prevent duplicate execution | [Execution and scheduler mechanics](#execution-and-scheduler-mechanics) | Scheduled and dormant authority | platform-engineering | boundary |
| [LC-E-030](#lc-e-030-a-recurring-triggers-own-dst-handling-can-skip-or-delay-an-occurrence-with-zero-authority-chain-event-involved) | A recurring trigger's own DST handling can skip or delay an occurrence with zero authority-chain event involved | [Execution and scheduler mechanics](#execution-and-scheduler-mechanics) | Scheduled and dormant authority | platform-engineering | boundary |
| [LC-F-030](#lc-f-030-a-duplicated-control-flow-statement-can-cause-a-verifier-to-skip-its-own-revocationsignature-check-entirely) | A duplicated control-flow statement can cause a verifier to skip its own revocation/signature check entirely | [Implementation or configuration defect](#implementation-or-configuration-defect) | Revocation, expiry and exhaustion | cryptography-and-pki | boundary |
| [LC-F-036](#lc-f-036-a-caches-actual-configured-ttl-can-silently-drift-longer-than-its-declared-freshness-policy) | A cache's actual configured TTL can silently drift longer than its declared freshness policy | [Implementation or configuration defect](#implementation-or-configuration-defect) | Notice, observation and reliance | platform-engineering | boundary |
| [LC-A-018](#lc-a-018-a-trustee-who-delegates-a-function-still-bears-supervisory-liability-for-the-delegate) | A trustee who delegates a function still bears supervisory liability for the delegate | [Liability or legal consequence](#liability-or-legal-consequence) | Dependencies and subdelegation | estates-and-trusts | boundary |
| [LC-A-020](#lc-a-020-executor-de-son-tort-acting-as-a-personal-representative-without-appointment-creates-personal-liability-not-authority) | Executor de son tort: acting as a personal representative without appointment creates personal liability, not authority | [Liability or legal consequence](#liability-or-legal-consequence) | Creation and activation | estates-and-trusts | boundary |
| [LC-A-030](#lc-a-030-a-third-party-who-wrongfully-refuses-a-valid-acknowledged-power-of-attorney-can-be-held-liable-subject-to-a-suspected-abuse-safe-harbor) | A third party who wrongfully refuses a valid, acknowledged power of attorney can be held liable, subject to a suspected-abuse safe harbor | [Liability or legal consequence](#liability-or-legal-consequence) | Notice, observation and reliance | agency-law | boundary |
| [LC-B-006](#lc-b-006-a-time-barred-remedy-does-not-cure-the-underlying-lack-of-authority) | A time-barred remedy does not cure the underlying lack of authority | [Liability or legal consequence](#liability-or-legal-consequence) | Notice, observation and reliance | civil-procedure | boundary |
| [LC-B-014](#lc-b-014-successor-liability-doctrine-is-a-liability-outcome-decided-on-facts-outside-the-delegation-graph) | Successor-liability doctrine is a liability outcome decided on facts outside the delegation graph | [Liability or legal consequence](#liability-or-legal-consequence) | Succession and replacement | corporate | boundary |
| [LC-C-024](#lc-c-024-a-shift-handover-can-transfer-authority-correctly-while-silently-losing-the-state-that-authority-depends-on) | A shift handover can transfer authority correctly while silently losing the state that authority depends on | [No authority transition in the scenario](#no-authority-transition-in-the-scenario) | Succession and replacement | industrial-safety | boundary |
| [LC-C-030](#lc-c-030-a-scope-restriction-tied-to-live-external-context-is-a-policy-question-not-an-authority-lifecycle-transition) | A scope restriction tied to live external context is a policy question, not an authority-lifecycle transition | [No authority transition in the scenario](#no-authority-transition-in-the-scenario) | Suspension, restriction and release | aviation | boundary |
| [LC-C-026](#lc-c-026-rank-based-succession-by-self-attestation-has-no-verifier-to-check-it-against) | Rank-based succession by self-attestation has no verifier to check it against | [No verifier in the scenario](#no-verifier-in-the-scenario) | Succession and replacement | military | boundary |
| [LC-F-021](#lc-f-021-browser-backforward-cache-can-display-a-stale-pre-revocation-authority-view-to-a-human-operator) | Browser back/forward cache can display a stale, pre-revocation authority view to a human operator | [No verifier in the scenario](#no-verifier-in-the-scenario) | Replication, rollback and stale state | platform-engineering | boundary |
| [LC-F-037](#lc-f-037-a-service-worker-offline-cache-can-serve-an-authority-bearing-view-after-revocation-with-no-distinction-from-static-assets) | A service-worker offline cache can serve an authority-bearing view after revocation with no distinction from static assets | [No verifier in the scenario](#no-verifier-in-the-scenario) | Replication, rollback and stale state | platform-engineering | boundary |
| [LC-D-002](#lc-d-002-okta-october-2023-a-service-account-credential-leaks-into-a-personal-account-through-an-ordinary-workflow-with-no-anomaly-in-the-credentials-own-usage-logs) | Okta October 2023: a service-account credential leaks into a personal account through an ordinary workflow, with no anomaly in the credential's own usage logs | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-005](#lc-d-005-slack-december-2022-an-unrelated-vendor-breach-exposes-employee-tokens-for-an-externally-hosted-code-repository-outside-the-orgs-own-iam) | Slack December 2022: an unrelated vendor breach exposes employee tokens for an externally hosted code repository outside the org's own IAM | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-006](#lc-d-006-ubiquiti-2020-an-engineers-undeclared-intent-to-leave-precedes-any-formal-offboarding-event-by-which-access-could-have-been-narrowed) | Ubiquiti 2020: an engineer's undeclared intent to leave precedes any formal offboarding event by which access could have been narrowed | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-007](#lc-d-007-desjardins-2017-2019-cumulative-over-extraction-within-an-otherwise-correctly-scoped-unrevoked-grant-undetected-for-26-months) | Desjardins 2017-2019: cumulative over-extraction within an otherwise correctly scoped, unrevoked grant, undetected for 26 months | [Security control](#security-control) | Evidence, attribution and completeness | security-incident | boundary |
| [LC-D-008](#lc-d-008-twitterzatko-2022-standing-privileged-access-granted-org-wide-with-no-logging-fine-grained-enough-to-attribute-individual-actions) | Twitter/Zatko 2022: standing privileged access granted org-wide with no logging fine-grained enough to attribute individual actions | [Security control](#security-control) | Evidence, attribution and completeness | security-incident | boundary |
| [LC-D-013](#lc-d-013-lastpass-2022-narrowing-key-custody-to-a-handful-of-named-holders-is-defeated-by-one-holders-unmanaged-personal-device) | LastPass 2022: narrowing key custody to a handful of named holders is defeated by one holder's unmanaged personal device | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-016](#lc-d-016-juniper-screenos-2012-2015-an-internally-self-consistent-but-substituted-cryptographic-constant-defeats-structural-verification-for-years) | Juniper ScreenOS 2012-2015: an internally self-consistent but substituted cryptographic constant defeats structural verification for years | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-017](#lc-d-017-codecov-2021-a-stolen-internal-build-credential-lets-an-attacker-silently-modify-a-widely-distributed-script-that-every-downstream-user-trusts-by-source-url-alone) | Codecov 2021: a stolen internal build credential lets an attacker silently modify a widely distributed script that every downstream user trusts by source URL alone | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-019](#lc-d-019-snowflake-2024-infostealer-harvested-credentials-remain-fully-sufficient-because-the-platform-did-not-enforce-a-second-factor-by-default) | Snowflake 2024: infostealer-harvested credentials remain fully sufficient because the platform did not enforce a second factor by default | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-020](#lc-d-020-mgm-resorts-2023-a-help-desk-roles-standing-power-to-reset-credentials-over-an-unverified-phone-call-becomes-the-entry-point) | MGM Resorts 2023: a help-desk role's standing power to reset credentials over an unverified phone call becomes the entry point | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-021](#lc-d-021-godaddy-2020-2022-three-incidents-disclosed-as-separate-events-later-turn-out-to-be-connected) | GoDaddy 2020-2022: three incidents disclosed as separate events later turn out to be connected | [Security control](#security-control) | Evidence, attribution and completeness | security-incident | boundary |
| [LC-D-022](#lc-d-022-dropbox-2022-a-phishing-page-captures-a-hardware-keys-one-time-code-defeating-a-control-marketed-as-phishing-resistant) | Dropbox 2022: a phishing page captures a hardware key's one-time code, defeating a control marketed as phishing-resistant | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-023](#lc-d-023-uber-2022-an-admin-credential-hardcoded-in-a-script-on-a-broadly-readable-network-share-becomes-full-administrative-takeover) | Uber 2022: an admin credential hardcoded in a script on a broadly readable network share becomes full administrative takeover | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
...
| [LC-D-026](#lc-d-026-opm-2015-a-contracting-company-disclaims-organizational-responsibility-for-the-scope-of-a-compromised-individual-employees-credential) | OPM 2015: a contracting company disclaims organizational responsibility for the scope of a compromised individual employee's credential | [Security control](#security-control) | Evidence, attribution and completeness | security-incident | boundary |
| [LC-D-027](#lc-d-027-home-depot-2013-a-narrowly-granted-vendor-credential-reaches-unrelated-systems-because-nothing-enforces-the-boundary-on-paper) | Home Depot 2013: a narrowly granted vendor credential reaches unrelated systems because nothing enforces the boundary on paper | [Security control](#security-control) | Identity, target and capability drift | security-incident | boundary |
| [LC-D-030](#lc-d-030-caesars-2023-attackers-target-an-outsourced-it-support-vendors-own-staff-rather-than-the-orgs-own-employees) | Caesars 2023: attackers target an outsourced IT support vendor's own staff rather than the org's own employees | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |
| [LC-D-031](#lc-d-031-beyondtrust-2023-2024-detection-speed-for-a-compromised-credential-varies-by-whether-that-credential-class-has-its-own-tailored-monitoring) | BeyondTrust 2023-2024: detection speed for a compromised credential varies by whether that credential class has its own tailored monitoring | [Security control](#security-control) | Evidence, attribution and completeness | security-incident | boundary |
| [LC-D-032](#lc-d-032-epamticketmaster-2024-malware-on-a-contractors-laptop-harvests-a-credential-together-with-the-cached-internal-url-needed-to-use-it-against-one-specific-client) | EPAM/Ticketmaster 2024: malware on a contractor's laptop harvests a credential together with the cached internal URL needed to use it against one specific client | [Security control](#security-control) | Credentials, keys and derived authority | security-incident | boundary |

</details>

## Execution and scheduler mechanics

Delivery, retry, lateness and overlap are execution behaviour. No authority transition happens in the scenario.
...
**Boundary reason.** This is about deduplicating the effect of an action across a retried request, not about the validity of the authority behind it. A system can get every authority check right and still double-execute without an idempotency mechanism. No authority state changes here, valid, revoked, suspended, or otherwise, so it fails criterion 1.
...
**Boundary reason.** Like LC-E-010, this is a request-deduplication mechanism, not an authority determination. The error it produces is about parameter mismatch on a reused key, not about whether any grant is valid, revoked, or suspended.
...
**Boundary reason.** Even a job whose authority chain is perfectly valid at every check can still misbehave if the scheduler has no policy for lateness or overlap. That is a property of the scheduling layer, not a verdict about delegated authority, so it fails criterion 1.
...
**Boundary reason.** The fix here is target-side deduplication keyed to the occurrence, not a change in any authority state. The scheduler's documented guarantee, not a lifecycle event, is what necessitates it, so this is a scheduler-mechanics case, not an authority verdict.
...
**Boundary reason.** The authority chain backing the action is completely unchanged and verifies identically regardless of the DST bug. This is entirely a trigger-mechanism correctness problem, with no authority state involved to render a verdict about, so it fails criterion 1.
...
The model already fixes the required behaviour. What is in question is whether a running system does what it declares, which is conformance testing and configuration monitoring.
...
The case ends in who is answerable rather than in an authority verdict. The underlying validity is untouched either way.
...
A verifier is present and returns the right answer, and nothing about authority changed. What moves is dependent operational state or live context.
...
**Boundary reason.** Nothing about the authority chain itself was invalid at handover. The failure is a loss of situational and safety state alongside a valid transfer, not an authority verdict a verifier could have gotten right or wrong. This is a completeness-of-state problem adjacent to lifecycle, not one inside it.
...
Variants: LC-C-019 (SBAR nursing handoff makes the same point as a positive requirement rather than a failure mode: a structured situational record should move with authority at handoff, and the incoming party's accountability should start at acceptance of that record, not at the authority event), LC-C-027 (anesthesia handover adds measured outcome data: unacknowledged handovers of a cumulative dosing and event record correlate with higher real-world error rates, not just a theoretical gap).
...
**Boundary reason.** Nothing here is issued, suspended, revoked, or expired. The delegation record never changes, only its situational applicability does, as a function of a continuously fluctuating context variable. That is an authorization-decision and policy-evaluation concern, not a transition in the authority artifact's own lifecycle state.
...
There is nobody to check the claim against, or the chain is correctly revoked and only a rendered view is stale, so no verification decision is wrong.
...
The case resolves into a control, detection or incident-governance question. The grant is valid throughout, or the case turns on whether a compromise would have been noticed, which no verifier decides from records.
